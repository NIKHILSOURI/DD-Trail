import keras
from utils.gan_training_utils import freeze_discriminator_for_generator_training
...
def generator_containing_discriminator(noise_dim, feature_dim, g, d):
    ...
    # Freeze entire D for the combined model so only G receives gradients from adversarial loss.
