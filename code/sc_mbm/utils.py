...
def load_model_full(checkpoint_path, model, optimizer=None, loss_scaler=None):
    """Load model, optimizer, scaler, epoch. Returns (model, optimizer, scaler, start_epoch)."""
    ...
    return model, opt, scaler, start_epoch
